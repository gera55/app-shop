            ...
            <div class="row">
                <div class="profile">
                    <div class="avatar text-center">
                        <img src="{{ asset($category->featured_image_url) }}" alt="Imagen representativa de la categoría {{ $category->name }}" class="img-circle img-responsive img-raised">
                    </div>
                    <div class="name">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="team-player">
                            <img src="{{ asset($product->featured_image_url) }}" alt="Thumbnail Image" class="img-raised img-circle">
                            <h4 class="title">
