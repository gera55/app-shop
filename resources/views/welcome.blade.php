        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger btn-raised btn-lg">
                    <i class="fa fa-play">&nbsp</i>¿Cómo funciona?</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="team-player">
                            <img src="{{ asset($category->featured_image_url) }}" alt="Imagen representativa de la categoría {{ $category->name }}" class="img-raised img-circle">
                            <h4 class="title">
