        ...
        <div class="section text-center">
            ...
            @foreach ($images as $image)
                <div class="col-md-4">
                    <div class="panel panel-default">
                        <div class="panel body">
                            <img src="{{ asset($image->url) }}" width="250">
                            <form method="post" action="">
                                ...
                                @if ($image->featured)
                                    <button type="button" class="btn btn-info btn-fab btn-fab-mini btn-round" rel="tooltip" title="Imagen destaca de este producto">
